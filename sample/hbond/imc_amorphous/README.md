...
- `output/imc_hbond_action.bdf` + `imc_hbond_show.act`: Mol_Name 維持 + Python action (`action` モード、**官能基単位** 色付け)
...
### (1) Python action 経路 (`<prefix>_action.bdf` + `<prefix>_show.act`、推奨)
