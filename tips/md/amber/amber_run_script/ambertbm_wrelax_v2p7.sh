...
&cntrl
  ...
  ntr=1, restraint_wt=$heatrestwt, restraintmask="${restmask}",
...
&cntrl
  ...
  ntp=1,
  ntr=1, restraint_wt=$den1wt, restraintmask="${restmask}",
...
&cntrl
  ...
  ntp=1,
  ntr=1, restraint_wt=$den2wt, restraintmask="${restmask}",
...
&cntrl
  ...
  ntp=1,
  ntr=1, restraint_wt=$den3wt, restraintmask="${restmask}",
