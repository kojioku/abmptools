...
- **[cg_segmenter](docs/cg_segmenter.md)** — CG (coarse-grained) segment builder. Physically splits a molecule into ring / chain segments with H or CH3 caps; allows atom sharing across fused-ring segments (v1.24.0+)
